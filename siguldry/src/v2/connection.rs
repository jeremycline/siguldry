...
//! 
//! 3. The client sends a command to the bridge. The bridge validates it and forwards
//!    it to the server connection.
//! 
//! 4. The client starts a nested TLS session within the TLS connection to the Sigul bridge,
...
//! 
//! 5. The inner TLS session is closed and communication resumes with the bridge as a proxy.
//! 
...
impl InnerConnection {
    ...
    pub async fn inner_request(
        ...
        let mut nestls = crate::v2::nestls::Nestls::connect(self.stream, ssl).await?;
