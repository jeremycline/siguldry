...
//! data to follow. Requests include a single section; a JSON-serialized, UTF-8 encoded
//! dictionary describing the request and its parameters.
//!
//! |---------------------------|
//! |        Frame Header       |
//! |---------------------------|
...
pub enum KeyAlgorithm {
    ...
    /// This exists exclusively for clients so that when they're updated,
    /// deserializing keys with new algorithms works properly.
...
mod tests {
    ...
    #[test]
    fn deserialize_key_without_hybrid_key_name() {
        let key: Key = serde_json::from_str(
            r#"{
                "name":"test-key",
                "key_algorithm":"Mldsa65",
                "handle":"key-handle",
        ...
        assert_eq!(key.hybrid_key_name, None);
    }
    ...
    fn serialize_digest_algorithms() {
        let digest_algorithms = [
            ...
            (DigestAlgorithm::MldsaMu, r#""MldsaMu""#),
        ];
