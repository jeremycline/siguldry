...
/// accepts the raw message M from FIPS 204 Algorithm 2 (ML-DSA.Sign). At this time, we
/// do not support the optional context parameter.
...
/// signature scheme definitions. At this time, we do not support the optional context
/// parameter or pre-hash flag.
